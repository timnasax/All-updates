...
zokou({ nomCom: "photolink", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
...
zokou({nomCom:"pocutor",categorie: "Conversion", reaction: "📸"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
